...
import co.edu.javeriana.ingsoft.quemadiaria.c.services.facade.RegistroFacade;
...
public class ControllerLogin {
    ...
    public void onclickIngresar(ActionEvent actionEvent) {
        ...
        if (loginExitoso) {
            Credenciales credenciales = credencialesUsuarioActivoUsuario(loginDTO);
            mainApp.setCredencialesUsuarioActivo(credenciales);
            Platform.runLater(() -> {
                try {
